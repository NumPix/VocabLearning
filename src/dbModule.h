 ...
 *  @return Exit code.
 */
int dbModule_insertOne(bson_t *doc, const char *collection_name);

/**
 *  @brief Finds a single BSON document in a specified collection based on the query.
 * 
...
/**
 * @brief Finds all BSON documents in a specified collection that match the query
 * 
 *  @param query A BSON document representing the query to match.
 *  @param opts Optional BSOM document with query options.
 *  @param read_prefs Read preferences for the query.
